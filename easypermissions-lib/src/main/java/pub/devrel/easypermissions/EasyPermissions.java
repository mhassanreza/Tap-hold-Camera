...
public class EasyPermissions {
	 ...
	 */
	public static void requestPermissions(int appDialogTheme, final Object object, String rationale,
	                                      final int requestCode, final String... perms) {
		requestPermissions(appDialogTheme, object, rationale,
				android.R.string.ok,
	...
	public static void requestPermissions(int appDialogTheme, final Object object, String rationale,
		...
		if ( shouldShowRationale ) {
			...
			AlertDialog dialog = new AlertDialog.Builder(activity, appDialogTheme)
