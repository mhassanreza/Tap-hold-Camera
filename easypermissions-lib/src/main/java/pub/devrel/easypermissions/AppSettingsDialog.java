...
public class AppSettingsDialog {
	...
	private AppSettingsDialog(@NonNull final Object activityOrFragment,
	                          ...
	                          int requestCode, int appCompatAlertDialogStyle) {
		
		// Create empty builder
		AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(context, appCompatAlertDialogStyle);
	...
	public static class Builder {
		...
		private int appCompatAlertDialogStyle;
		 ...
		 * @param appCompatAlertDialogStyle
		 */
		public Builder(@NonNull Activity activity, @NonNull String rationale, int appCompatAlertDialogStyle) {
			mActivityOrFragment = activity;
			mContext = activity;
			mRationale = rationale;
			this.appCompatAlertDialogStyle = appCompatAlertDialogStyle;
		}
		...
		public AppSettingsDialog build() {
			return new AppSettingsDialog(mActivityOrFragment, mContext, mRationale, mTitle,
					mPositiveButton, mNegativeButton, mNegativeListener, mRequestCode, appCompatAlertDialogStyle);
		}
